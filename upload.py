...
def validate_files():
    ...
    try:
        ...
        # Check total size
        if total_size > MAX_FILE_SIZE * 5:  # 25MB total
            return jsonify({
                'error': 'Total file size too large',
                'max_total_size': MAX_FILE_SIZE * 5
            }), 400
    ...
    try:
        ...
        for file in files:
            ...
            try:
                ...
                return jsonify({
                    'error': f'File {filename} contains invalid characters. Please ensure it is a valid text file.'
                }), 400
