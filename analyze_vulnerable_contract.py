...
def analyze_vulnerable_contract():
    """Analyze the more vulnerable contract"""
    print("Analyzing vulnerable contract...")
    
    # Read the contract file
    try:
        with open('vulnerable_contract.sol', 'r') as f:
